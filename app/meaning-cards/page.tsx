...
export const metadata: Metadata = {
  title: 'Meaning Cards',
  description:
    'Explore heartfelt meaning cards and thoughtful message ideas for love, gratitude, pride, comfort, hope and joy.',
  alternates: {
  ...
  return (
    <section>
      ...
      <h1 className="mt-4 font-serif text-4xl text-deep-rose">
        Words that deepen the moment
      </h1>

      <p className="mt-3 max-w-2xl text-stone-700">
        Pair every gesture with language that feels sincere, intimate, and human.
      </p>
