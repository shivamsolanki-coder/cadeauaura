...
export default async function CategoryDetailPage({ params }: CategoryPageProps) {
  ...
  return (
    <section className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-aura-radial p-6 shadow-aura md:p-10">
      ...
      <div className="relative z-10 grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        ...
        <Image
          src={category.image}
          alt={`${category.name} premium visual`}
          width={720}
          height={540}
          className="rounded-[2rem] border border-gold-200/20 object-cover shadow-aura"
          priority
        />
      </div>
    </section>
